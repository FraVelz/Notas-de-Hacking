...
Todo acerca de permisos:

* [Ir a 9. Permisos](#9-permisos-y-usuarios)

* [Ir a 10. Sudo](#10-sudo)
...
| Archivos   | `cat`          | Muestra el contenido de un archivo. | `cat archivo.txt`               |
|            | `cp`           | Copia archivos o carpetas.          | `cp file.txt /tmp/`             |
|            | `mv`           | Mueve o renombra archivos.          | `mv file.txt new.txt`           |
